...
MCBManager does its best with detecting and importing addons. However, not all addons are created equal. I am actively working on improving the detection and import process. If you encounter issues with importing addons, please report them on the [Issues Page](https://github.com/SiderealEmu/MCBManager/issues).
